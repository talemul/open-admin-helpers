...
<div class="card card-primary">
    <div class="card-header with-border">
        ...
        <div class="card-tools pull-right" data-toggle="tooltip" title="Status">
            <div class="input-group input-group-sm" style="width: 150px;">
                <select name="connection" id="connections" class="form-select pull-right" style="margin-right: 10px;">
    ...
    <div class="card-body chat" id="terminal-card"></div>

    <div class="card-footer with-border">
        <div class="input-group">
            <input class="form-control input-lg" id="terminal-query" placeholder="Type query...">
            <div class="input-group-btn">
                <button type="button" class="btn btn-primary btn-lg" id="terminal-send"><i class="icon-paper-plane"></i></button>
            </div>
            <div class="input-group-btn">
                <button type="button" class="btn btn-warning btn-lg" id="terminal-clear"><i class="icon-trash"></i></button>
            </div>
        </div>
    </div>
</div>
